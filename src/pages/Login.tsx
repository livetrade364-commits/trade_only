...
import { LogIn, TrendingUp, ArrowRight, Lock, Mail } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-white flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-slate-900 relative overflow-hidden">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1611974765270-ca12586343bb?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80')] bg-cover bg-center opacity-20"></div>
        ...
        <div className="relative z-10 w-full flex flex-col justify-between p-12">
          ...
          <div className="space-y-6">
            <h1 className="text-4xl font-bold text-white leading-tight">
              Master the Markets with Real-Time Insights
            </h1>
            <p className="text-lg text-gray-300 max-w-md">
              Join thousands of investors using Lozzby Tech to track, analyze, and optimize their portfolios with institutional-grade data.
            </p>
        ...
        <div className="mx-auto w-full max-w-sm lg:w-96">
          ...
          <div className="mt-8">
            ...
            <p className="mt-8 text-center text-sm text-gray-600">
              ...
              <Link to="/signup" className="font-bold text-blue-600 hover:text-blue-500 hover:underline transition-all">
                Sign up for free
              </Link>
            </p>
          </div>
